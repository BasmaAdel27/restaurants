        ...
        <form action="{{ route('admin.orders.store') }}" method="post" enctype="multipart/form-data"
          ...
          <div class="row">
            ...
            <div class="form-group col-6">
              ...
              <input type="number" name="moves_number" class="form-control" min="0" value="{{old('moves_number')}}">
            </div>
            ...
            <div class="form-group col-6">
              ...
              <input type="text" name="order_pocket" class="form-control" value="{{old('order_pocket')}}" >
            </div>
            ...
            <div class="form-group col-12" style="margin-top: 10px">
              <label>@lang("address")</label>
              <input type="text" class="form-control" name='address_end' id="location2" value="{{old('address_end')}}">
            </div>
          </div>
          <div class="row">
            <div class="form-group col-6">
