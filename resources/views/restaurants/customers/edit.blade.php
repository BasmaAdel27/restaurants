  ...
  <div class="container">
    ...
    <div class="card mt-5">
      ...
      <div class="card-body table-responsive">
        <form action="{{ route('restaurant.customers.update',$customer) }}" method="post" >@csrf
          @method('PUT')
          <div class="row">
            ...
            <div class="form-group col-6">
              ...
              <input type="date" class="form-control" name='birth_date' value="{{old('birth_date',$customer->birth_date)}}">
            </div>
            <div class="form-group col-6">
              <label>@lang("phone")</label>
              <input type="text" class="form-control" name='phone'value="{{old('phone',$customer->phone)}}" placeholder="00966xxxxxxxxx">
            </div>
